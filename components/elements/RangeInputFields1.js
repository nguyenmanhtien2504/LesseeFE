...
const RangeInputFields1 = ({ onFilterChange }) => { // Thay đổi tên prop thành onFilterChange
  ...
  return (
    <div>
      ...
      <span style={{ color: '#fff' }}>Giá Tiền: {formattedAmountValues[0]} - {formattedAmountValues[1]}</span>
      <br />
      <br />
      ...
      <span style={{ color: '#fff' }}>Diện tích: {formattedDistanceValues[0]} - {formattedDistanceValues[1]}</span>
      <br />
