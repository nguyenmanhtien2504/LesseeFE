...
import { DropdownInputFields } from "../../../elements/DropdownInputFieldsTest1";
import RangeInputFields from "../../../elements/RangeInputFields";
import RangeInputFields1 from "../../../elements/RangeInputFields1";
...
const InputForm = ({ label, lg, sm, lastSm }) => {
  ...
  return (
    <Row className="gx-3">
      ...
      <RangeInputFields1 onFilterChange={handleFilterChange} />
      <Col lg={lg || 12}>
